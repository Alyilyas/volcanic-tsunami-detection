...
```
This script run the final validation. To reproduce a specific figure from the manuscript, you can follow the instructions in the table below. If you are using new data, you must edit the CONFIG with the parameters you found in Part 1.
...
| :--- | :--- | :--- |
| **Quick Test** (T1) | `python code/generate_spectral_threshold_test.py` | Run script directly. A fast, low-quality test using `n_bootstrap: 100`.<br/>Use this to verify the script runs without errors. |
