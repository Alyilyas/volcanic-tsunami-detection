...
| **Fig. 14** (Ruang) | `python code/generate_spectral_detection_plot_ruang.py` | Run script directly. This is a separate validation for the Ruang volcano.<br/>(Edit `CONFIG` as needed). |
